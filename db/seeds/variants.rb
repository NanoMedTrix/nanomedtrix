nmt_re_xxa             = Spree::Product.find_by_name!( 'NMTx NMT-RE -xxa' )
nmt_re_xxb             = Spree::Product.find_by_name!( 'NMTx NMT-RE -xxb' )
nmt_re_xxx             = Spree::Product.find_by_name!( 'NMTx NMT-RE -xxx' )
nmt_msn_xxa            = Spree::Product.find_by_name!( 'NMTx NMT-MSN -xxa' )
nmt_msn_xxb            = Spree::Product.find_by_name!( 'NMTx NMT-MSN -xxb' )
nmt_msn_xxx            = Spree::Product.find_by_name!( 'NMTx NMT-MSN -xxx' )
